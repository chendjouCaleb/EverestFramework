 ...
 * classes. It also provides easy-to-use methods to Converter between
...
public class StringUtils {
    ...
    /**
     * Take a {@code String} that is a delimited list and Converter it into a
     * {@code String} array.
    ...
    /**
     * Take a {@code String} that is a delimited list and Converter it into
     * a {@code String} array.
     * <p>A single {@code delimiter} may consist of more than one character,
     * but it will still be considered as a single delimiter string, rather
     * than as bunch of potential delimiter characters, in contrast to
